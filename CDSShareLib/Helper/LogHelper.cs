...
namespace CDSShareLib.Helper
{
    ...
    public class LogHelper
    {
        ...
        public LogHelper(string storageConnectionString, string storageContainer, LogLevel logLevel)
        {
            try
            {
                _logLevel = logLevel;

                CloudStorageAccount strAcc = CloudStorageAccount.Parse(storageConnectionString);
