...
namespace sfAPIService.Controllers
{
    ...
    [RoutePrefix("admin-api/SubscriptionPlan")]
    public class SubscriptionPlanController : ApiController
    {
        ...
        /// </summary>
        [HttpGet]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(List<SubscriptionPlanModel.Format_Detail>))]
        public IHttpActionResult GetAllSubscriptionPlan()
        {
        ...
        [HttpGet]
        [Route("{id}")]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(SubscriptionPlanModel.Format_Detail))]
        public IHttpActionResult GetSubscriptionPlanById(int id)
        {
            try
            {
                SubscriptionPlanModel model = new SubscriptionPlanModel();
        ...
        /// </summary>
        [HttpPost]
        public IHttpActionResult CreateSubscriptionPlan([FromBody]SubscriptionPlanModel.Format_Create dataModel)
        {
        ...
        [HttpPatch]
        [Route("{id}")]
        public IHttpActionResult UpdateSubscriptionPlan(int id, [FromBody]SubscriptionPlanModel.Format_Update dataModel)
        {
            string logForm = "Form : " + JsonConvert.SerializeObject(dataModel);
        ...
        [HttpDelete]
        [Route("{id}")]
        public IHttpActionResult DeleteSubscriptionPlan(int id)
        {
            try
            {
                SubscriptionPlanModel model = new SubscriptionPlanModel();
