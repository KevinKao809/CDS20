...
namespace sfAPIService.Controllers
{
    ...
    public class DeviceTypeController : ApiController
    {
        ...
        /// </summary>
        [HttpGet]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(List<DeviceTypeModel.Format_Detail>))]
        [CustomAuthorizationFilter(ClaimType = "Roles", ClaimValue = "superadmin, admin")]
        public IHttpActionResult GetAllDeviceType()
        {
        ...
        [HttpGet]
        [Route("{id}")]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(DeviceTypeModel.Format_Detail))]
        ...
        /// </summary>
        [HttpPost]
        public IHttpActionResult CreateDeviceType([FromBody]DeviceTypeModel.Format_Create dataModel)
        {
        ...
        [HttpPatch]
        [Route("{id}")]
        public IHttpActionResult UpdateDeviceType(int id, [FromBody]DeviceTypeModel.Format_Update dataModel)
        {
            string logForm = "Form : " + JsonConvert.SerializeObject(dataModel);
