...
namespace sfAPIService.Controllers
{
    ...
    [RoutePrefix("admin-api/Application")]
    public class ApplicationController : ApiController
    {
        ...
        /// </summary>
        [HttpGet]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(List<ApplicationModel.Format_Detail>))]
        ...
        [HttpGet]
        [Route("{id}")]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(ApplicationModel.Format_Detail))]
        ...
        /// </summary>
        [HttpPost]
        public IHttpActionResult CreateApplication([FromBody]ApplicationModel.Format_Create dataModel)
        {
        ...
        [HttpPatch]
        [Route("{id}")]
        public IHttpActionResult UpdateApplication(int id, [FromBody]ApplicationModel.Format_Update dataModel)
        {
            string logForm = "Form : " + JsonConvert.SerializeObject(dataModel);
